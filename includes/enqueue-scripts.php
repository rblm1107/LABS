...
class Scripts
{
    public static function ajouter_css_js()
    {
        ...
        // wp_enqueue_script("jquery-perso", get_template_directory_uri() . '/js/jquery-2.1.4.min.js', [], '', true);
        // wp_enqueue_script("bootstrap-js", get_template_directory_uri() . '/js/bootstrap.min.js', [], null, true);
        // wp_enqueue_script("magnific-perso", get_template_directory_uri() . '/js/magnific-popup.min.js', [], null, true);
        // wp_enqueue_script("owl-1", get_template_directory_uri() . '/js/owl.carousel.min.js', [], null, true);
